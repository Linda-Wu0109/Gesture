package com.example.twpus1121113myapplication
...
import com.example.twpus1121113myapplication.ui.theme.Twpus1121113MyApplicationTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            Twpus1121113MyApplicationTheme {
...
@Composable
fun PointerEvents() {
    var msg by remember { mutableStateOf("作者：吳奕伶") }
    Column {
        Text("\n" + msg)
        Box(
            Modifier
